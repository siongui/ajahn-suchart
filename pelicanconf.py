...
AUTHOR = u'Ajahn Suchart Abhijāto'
SITENAME = u'Ajahn Suchart Abhijāto'
...
META_KEYWORDS = 'Ajahn Suchart Abhijāto'
META_DESCRIPTION = 'Ajahn Suchart Abhijāto'
...
CONTENT_DIR_URL = u'https://github.com/siongui/ajahn-suchart/tree/master/content'
